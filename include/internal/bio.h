...
# define BIO_CTRL_SET_KTLS_TX_ZEROCOPY_SENDFILE 82
# define BIO_CTRL_GET_KTLS_TX_ZEROCOPY_SENDFILE 83
...
# define BIO_should_ktls_zerocopy_sendfile_flag(b) \
    BIO_test_flags(b, BIO_FLAGS_KTLS_TX_ZEROCOPY_SENDFILE)
